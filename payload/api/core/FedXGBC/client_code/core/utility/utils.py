...
class Utils:
    ...
    def configure_logging(self, log_directory: str, printing_required: bool) -> None:
        ...
        # Set up logging
        log_file = os.path.join(log_directory, f'modelling_logs.log')  # Set log file path with timestamp
    ...
    def get_and_make_experiment_path(self):
        self.experiment_path = os.path.join(
            "models",
            self.config.get('BASE_SETTINGS', 'modelling_which_disease'),
            self.config.get('FILE_SETTINGS', 'prefix_to_experiment_path'))

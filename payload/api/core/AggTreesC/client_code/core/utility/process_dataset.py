...
class ProcessDataset:
    ...
    def _split_x_y(self, x, y):
        ...
        x_train_val, x_test, y_train_val, y_test = train_test_split(x, y, test_size=0.0001, random_state=42, shuffle=True)
        
        if self.val_required:
            x_train, x_val, y_train, y_val  = train_test_split(x_train_val, y_train_val, test_size=0.0001, random_state=42,  shuffle=True)
